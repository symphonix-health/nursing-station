...
SITES: list[tuple[str, list[str], list[tuple[str, int, str]]]] = [
    ...
    (
        ...
        [("backend/nursing_station/main.py", 271, "alerts")],
    ),
    (
        "alerts.acknowledge",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/main.py", 290, "acknowledge_alert")],
    ),
    (
        "hmis_measures.submit",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/main.py", 647, "submit_hmis_measures")],
    ),
    (
        "observation.write",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1005, "add_observation")],
    ),
    (
        "task.create",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1136, "create_task")],
    ),
    (
        "task.transition",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1169, "transition_task")],
    ),
    (
        "handover.create",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1237, "create_handover")],
    ),
    (
        "care_plan.create",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1398, "create_care_plan")],
    ),
    (
        "care_plan.evaluate",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1419, "evaluate_care_plan")],
    ),
    (
        "medication_administration.write",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1468, "administer")],
    ),
    (
        "safety_assessment.write",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/main.py", 1604, "assess")],
    ),
    (
        "audit.read",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/main.py", 1637, "audit_log")],
    ),
    ...
    (
        "patient.read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/main.py", 128, "scoped_patient")],
    ),
    # ---- national_routes.py (23 sites) -------------------------------------
    (
        "country_pack.adopt",
        ["clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 280, "record_adoption")],
    ),
    (
        "work_queue.read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 328, "work_queue_view")],
    ),
    (
        "competency.read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 401, "ward_competencies")],
    ),
    (
        "task_interruption.create",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 424, "record_interruption")],
    ),
    (
        "task_interruption.resume",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 458, "resume_interruption")],
    ),
    (
        "escalation.read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 487, "escalations")],
    ),
    (
        "escalation.respond",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 524, "record_escalation_response")],
    ),
    (
        "harm_incident.write",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 606, "report_harm_incident")],
    ),
    (
        "harm_incident.read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 683, "list_harm_incidents")],
    ),
    (
        "harm_incident.review",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 700, "review_harm_incident")],
    ),
    (
        "discharge_readiness.write",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 768, "open_discharge_readiness")],
    ),
    (
        "discharge_readiness.confirm",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 846, "confirm_criterion")],
    ),
    (
        "discharge_readiness.coordinate",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 899, "coordinate_discharge")],
    ),
    (
        "discharge_readiness.complete",
        ["registered_nurse", "nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 998, "complete_discharge_readiness")],
    ),
    (
        "staffing.position_read",
        ["registered_nurse", "nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1069, "staffing_position")],
    ),
    (
        "staffing.roster_refresh",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1091, "refresh_staffing_roster")],
    ),
    (
        "staffing.declare",
        ["nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 1162, "declare_staffing_shortage")],
    ),
    (
        "staffing.revoke",
        ["nurse_in_charge"],
        [("backend/nursing_station/national_routes.py", 1222, "revoke_staffing_declaration")],
    ),
    (
        "staffing.declarations_read",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1249, "list_staffing_declarations")],
    ),
    (
        "quality_measures.read",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1270, "quality_measures")],
    ),
    (
        "publications.read",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1293, "list_publications")],
    ),
    (
        "publications.dispatch",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1387, "dispatch_publication")],
    ),
    (
        "publications.dispatch_pending",
        ["nurse_in_charge", "clinical_safety_officer"],
        [("backend/nursing_station/national_routes.py", 1407, "dispatch_pending_publications")],
    ),
]
