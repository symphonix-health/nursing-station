...
def manifest(record_counts: dict[str, int], generated_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "domains_seeded": [
            ...
            "care_planning",
            "cross_system_identity_alignment",
        ],
        "record_counts_expected": record_counts,
        "record_counts_landed": record_counts,
        "back_correction_enabled": False,
        "back_correction_ruleset_id": "dq.nursing_station.phase2_identity_v1",
        "terminology_ruleset_id": "terminology.nursing_station.phase2_v1",
        "data_quality_ruleset_id": "dq.nursing_station.phase2_v1",
        "privacy_policy_id": "privacy.seeded_synthetic.nursing_station_v2",
        ...
        "approved_for_use_case": [
            ...
            "real seeded sibling integration verification",
        ],
        "limitations": [
            ...
            "The two linked personas are deterministic synthetic alignment records, not master-registry proof.",
        ],
    }
