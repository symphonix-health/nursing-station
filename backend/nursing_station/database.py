...
CREATE TABLE IF NOT EXISTS handovers (
 ...
 unresolved_tasks_json TEXT NOT NULL, status TEXT NOT NULL,
...
class Database:
    ...
    def _seed(self, conn: sqlite3.Connection) -> None:
        ...
        observations = [
            ("obs-seed-001",tenant,"ward-med-a","pat-001","usr-amina",(now-timedelta(minutes=18)).isoformat(),"seeded bedside observation",22,94,1,112,96,38.2,"alert",5,"urgent"),
            ("obs-seed-002",tenant,"ward-med-a","pat-002","usr-grace",(now-timedelta(minutes=42)).isoformat(),"seeded bedside observation",18,97,0,118,84,36.7,"alert",0,"routine"),
            ("obs-seed-003",tenant,"ward-med-a","pat-003","usr-amina",(now-timedelta(minutes=25)).isoformat(),"seeded bedside observation",19,98,0,126,88,37.1,"alert",0,"routine"),
        ]
